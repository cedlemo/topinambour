...
module About
  ...
  COMMENTS = "Terminal Emulator based on the ruby bindings of Gtk3 and Vte3".freeze
  COPYRIGHT = "Copyright (C) 2015-2018 Cedric Le Moigne".freeze
  LICENSE = "This program is licenced under the licence GPL-3.0 and later.".freeze
